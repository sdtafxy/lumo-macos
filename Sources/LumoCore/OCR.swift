...
public enum OCRError: LocalizedError {
    case noResult
    public var errorDescription: String? { "未能识别出任何文字" }
}
...
public enum OCR {
    ...
    public static let languages: [OCRLanguage] = [
        OCRLanguage(id: "chi_sim+eng", name: "中文 + 英文", codes: ["zh-Hans", "en-US"]),
        OCRLanguage(id: "chi_sim",     name: "中文简体",    codes: ["zh-Hans"]),
        OCRLanguage(id: "chi_tra+eng", name: "中文繁体 + 英文", codes: ["zh-Hant", "en-US"]),
        OCRLanguage(id: "eng",         name: "英文",        codes: ["en-US"]),
        OCRLanguage(id: "jpn",         name: "日文",        codes: ["ja-JP"]),
        OCRLanguage(id: "kor",         name: "韩文",        codes: ["ko-KR"]),
        OCRLanguage(id: "fra",         name: "法文",        codes: ["fr-FR"]),
        OCRLanguage(id: "deu",         name: "德文",        codes: ["de-DE"]),
        OCRLanguage(id: "spa",         name: "西班牙文",    codes: ["es-ES"]),
        OCRLanguage(id: "ita",         name: "意大利文",    codes: ["it-IT"]),
        OCRLanguage(id: "por",         name: "葡萄牙文",    codes: ["pt-BR"]),
        OCRLanguage(id: "rus",         name: "俄文",        codes: ["ru-RU"]),
    ]
