...
enum LumoAppearance: String, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .light:  return T("浅色")
        case .dark:   return T("深色")
        }
    }

    var nsAppearance: NSAppearance? {
        switch self {
        case .system: return nil                       // nil 就是T("跟随系统")
...
enum LumoGlass: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .solid:    return T("不透明")
        case .standard: return T("玻璃")
        case .vivid:    return T("通透")
        }
    }

    var hint: String {
        switch self {
        case .solid:    return T("内容完全不透明，可读性最好")
        case .standard: return T("控件层有玻璃，内容层留一点底色")
        case .vivid:    return T("整窗透出桌面，最接近系统原生观感")
        }
    }
